...
class error_correction_transmission {
    ...
    // to detect error in the received data
    static void receiveData(int data[], int parityBits) {
        ...
        // errorLoc string for storing the integer value of the error location.
        String errorLoc = new String();

        // for loop to check the parities
